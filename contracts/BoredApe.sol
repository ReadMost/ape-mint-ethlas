    ...
    PaymentSplitter
{
    ...
    uint256[] private _teamShares = [25]; // 1 PERSON IN THE TEAM
    address[] private _team = [
        0xEB8fb2f6D41706759B8544D5adA16FC710211ca2 // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("BoredApeEthlas", "APEE")
